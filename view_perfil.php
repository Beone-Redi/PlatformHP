...
elseif(isset($_POST['inputCard']))
{
    ...
    $tipeCard=1;
    $data_company=$app->viewCompany($Company);
    $KC=$data_company[16];
    ...
    if($IdUserAPI[0]==='')// si no se tiene el idapi
    {
        ...
        {
            $IdUserAPI=$app->IdAPIByUser($_GET['idu']);// Obtiene el idapi y password
            $Data=[$IdUserAPI[0],$IdCard,$Month,$Anio,$Company,$Usuario,$City,$tipeCard];//IdUSerAPI,Idcard,mes,anio,compañia,usuario,ciudad
            $Resultado=$app->NewCard( $Data,$dataComision,$KC );
        }
        else
        {
                ...
                <div class="row">
                    ...
                    <?php } elseif ( strlen( $msg ) == 5 ) { ?>
                        <div class="alert alert-danger">
                            <button type="button" aria-hidden="true" class="close">×</button>
                            <span><b> Error - </b> No se a podido actualizar verifique los datos e intente mas tarde.</span>
                        </div>
                    <?php } ?>
                    <?php if ( strlen( $msg2 ) == 6 ) { ?> 
                        <div class="alert alert-success">
                            <button type="button" aria-hidden="true" class="close">×</button>
                            <span><b> Exitoso - </b> Se dio de alta la tarjeta de forma exitosa.</span>
                        </div>
                    ...
                    <div class="col-md-8">  
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Datos del Tarjetahabiente</h4>
                            </div>
                            <div class="content">
                                <form method="POST" action="view_perfil?scr=9&idu=<?php echo $_GET['idu']; ?>" id="form1"  onsubmit="return checkSubmitBlock('btsubmit');">
                                    ...
                                    <button type="submit" id="btsubmit" class="btn btn-info btn-fill pull-right" form="form1"> Actualizar Perfil</button>
                                    &nbsp;
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Alta de nueva tarjeta</h4>
                            </div>
                            <div class="content">
                                <form method="POST" action="view_perfil?scr=9&idu=<?php echo $_GET['idu']; ?>" id="form2" onsubmit="return checkSubmitBlock('btsubmit2');">
                                    ...
                                    <br><br>
                                    <button type="submit" id="btsubmit2" class="btn btn-info btn-fill pull-lefth" form="form2">Guardar</button>
                                    <div class="clearfix"></div>
                                </form>
                            </div>
                        </div>
