                ...
                <div class="row">
                    ...
                    <?php if ( strlen( $msg ) == 6 ) { ?> 
                        <div class="alert alert-success">
                            ...
                            <span><b> successfull - </b> Datos Actualizados correctamente.</span>
                        </div>
                    <?php } elseif ( strlen( $msg ) == 5 ) { ?>
                        <div class="alert alert-danger">
                            <button type="button" aria-hidden="true" class="close">×</button>
                            <span><b> Error - </b> Fallo al actualizar los datos, intentelo mas tarde.</span>
                        </div>
                    <?php } ?>
                            ...
                            <div class="content">
                                <div class="author">
                                    <a href="#">
                                        ...
                                        <h4 class="title"><?php echo utf8_encode($dUsuario[2]); ?><br />
