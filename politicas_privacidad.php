                                ...
                                <p class="category">
                                    ...
                                    <br>
                                        <p align="justify" style="font-size:14px;">
                                            HotPay S.A. de C.V, con domicilio en Av. Fundadores 955, P13, Int 1301 Col. Valle Oriente San Pedro Garza García, Nuevo León, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
                                        </p>
                                        <br>
