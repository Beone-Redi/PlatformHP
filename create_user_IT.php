...
{*/
    if(isset($_POST["layoutcarga"]))
    {
        ...
        $cards=[];
        $string_card=$app->GetCardsCompanyByIde($empresa);
        if($string_card!='')
        {       
                                    ...
                                    if(sizeof($datos)==8)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if($band_correo==0)
                                            {
                                                ...
                                                sleep(1);
                                                $Respuesta1 = $app->NewCardHolderLayout( $aCompany,$_SESSION['USER'],$img_perfil );
                                                if(substr( $Respuesta1, 0, 2 ) <> '01') // si se creo correctamente el usuario
                                                {
                                                    ...
                                                    $Respuesta2=$app->NewCard( $Data,$dataComision ); 
                                                }                                    
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="content">     
                        <form action="create_user_IT?scr=9" method="POST" id="form2" enctype="multipart/form-data" onsubmit="return checkSubmitBlock('btsubmit3');">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="inputCards">Tipo de tarjeta </label>
                                        <select class="form-control tarjetas" name="inputCards[]">
                                            <option value=""></option>
                                            <?php for($i=0;$i<sizeof($tarjetas);$i+=5)
                                            {?>
                                                <option value="<?php echo utf8_encode($tarjetas[$i+3]); ?>"><?php echo $tarjetas[$i+3].' - '.utf8_encode($tarjetas[$i]);?></option>
                                            <?php
                                            }?>
                                        </select> 
                                    </div>
