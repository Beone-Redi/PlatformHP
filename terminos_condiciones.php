                                ...
                                <p class="category">
                                    ...
                                    <br>
                                        <p align="justify" style="font-size:14px;">
                                            HotPay S.A. de C.V, una empresa que está comprometida a proteger su privacidad. Además de lo dispuesto en la ley y su reglamento correspondiente en la materia, 
                                       ...
                                       <br>
                                        ...
                                        <p align="justify" style="font-size:14px;">
                                            Estas terminos y condiciones son aplicables específicamente a la información que recopilamos de usted a través de nuestra aplicación denominada HotPay y plataforma de HotPay S.A. de C.V.
                                        ...
                                        <br>
                                        <p align="justify" style="font-size:14px;">        
                                        Usted se compromete a que los datos que proporciona a HotPay S.A. de C.V sean verídicos, completos y exactos. Cualquier dato falso, incompleto o inexacto al momento de recabarlos, será de su exclusiva responsabilidad, 
                                        en caso de que requiera rectificar alguno de ellos, le ofrecemos que lo haga directamente a través de su cuenta de Usuario o bien al correo electrónico: contacto@hotpay.mx</p>
                                        ...
                                        <p align="justify" style="font-size:14px;">
                                            ...
                                            o interfieran en, los derechos de HotPay S.A. de C.V, sus propiedades, de otros Usuarios del portal o de cualquier persona que pudiese resultar perjudicada por dichas acciones.
                                        </p>
                                        <br>
                                        ...
                                        <br>
                                        <p align="justify" style="font-size:14px;">
                                            6. El usuario otorga su consentimiento a HotPay S.A. de C.V para que le envíe todo tipo de publicidad, incluyendo promociones. 
                                        ...
                                        <p align="justify" style="font-size:14px;">
                                            ...
                                            <br><br>
                                            En HotPay S.A. de C.V usamos las cookies para:
                                            <br>
                                        ...
                                        <br>
                                        <p align="justify" style="font-size:14px;">
                                            8. Este aviso de privacidad cumple con los requisitos que marca la ley (artículos 15 y 16). HotPay S.A. de C.V toma muy en cuenta la seguridad de 
                                        ...
                                        <br>
                                        <p align="justify" style="font-size:14px;">
                                            9. HotPay S.A. de C.V se reserva el derecho de cambiar este aviso de privacidad en cualquier momento, mediando la debida notificación que exige la ley. 
                                            En caso de que exista algún cambio en este aviso de privacidad, HotPay S.A. de C.V lo comunicará de la siguiente manera: (a) enviándole un correo electrónico a la cuenta 
                                            que ha registrado en la aplicación y/o (b) publicando una nota visible en nuestra aplicación. HotPay S.A. de C.V no será responsable si usted no recibe la notificación de 
                                        ...
                                        <p align="justify" style="font-size:14px;">
                                            ...
                                            <br>
                                            Domicilio: Av. Fundadores 955, P13, Int 1301 Col. Valle Oriente San Pedro Garza García, Nuevo León.
                                            <br>
                                            Correo Electrónico: contacto@hotpay.mx
                                            <br>
                                            Teléfono: +52 (81) 2525-0168
                                            <br>
                                        ...
                                        <br>
                                        <p align="justify" style="font-size:14px;">
                                            12. Al hacer uso de la plataforma HotPay S.A. de C.V, usted renuncia a cualquier otro fuero y legislación que le pudiere corresponder. 
                                            ...
                                            <br>
                                            <br>13. Estos terminos y condiciones quedan aceptados en el momento de registrarse en nuestra aplicación HotPay y plataforma de HotPay S.A. de C.V.</p>
                                        <br>
