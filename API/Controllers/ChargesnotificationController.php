...
$data=
    [
        ...
        clientKey=>GG2SZ7AJ34WSHOK1KI55Y8,1
        Card=>'12345678',2
        Amount=>10,3
                    ...
                    if(sizeof($company)>0)
                    {
                        ...
                        if(sizeof($AuthCode)>0)
                        {
                            ...
                            $mail_mensaje='<table>
                                ...
                                '<tr><td> Motivo Error </td><td> '.'CODIGO DE AUTORIZACION REPETIDO HOTPAY'.'</td></tr></table>';
                            $email->enviarmail($mail_mensaje,'CODIGO DE AUTORIZACION REPETIDO HOTPAY');
                            $response=
                            [
                                'SystemTraceAuditNumber'=>date('ymdHis'),
                                'ResponseCode'=>'65',
