                            ...
                            <div class="header">
                                ...
                                <p class="category">
                                    ...
                                    <a href="create_user?scr=9" class="btn btn-default btn-sm" >
                                        <i class="pe-7s-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;<label><b>Alta tarjetahabiente</b></label>
                                    </a>
                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="submit" class="form-control" id="busqueda" value="Buscar">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <table class="table table-hover table-striped" id="CH">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                                <a href="view_perfil?scr=9&idu=<?php echo $dUsuariosI[$i]; ?>" rel="tooltip" title="Editar" class="btn btn-default btn-sm">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                ?>
                                                <a  href="clients?scr=9&urlToken=<?php echo $urlToken; ?>&idu=<?php echo $dUsuariosI[$i]; ?>&sta=<?php echo $dUsuariosI[$i + 5]; ?>" class="btn btn-default btn-sm" rel="tooltip" title="Desactivar" >
