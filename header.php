                            ...
                            <?php if ( $subApp->optSearch($_SESSION[ 'PERMISOS' ],'opt64')) { // Ver Reportes de pagos paynet?>
                                <li <?php if ( $SCRN == 10 ) { echo $active; } ?>>
                                    <a class="nav-link py-0" href="cards_view_users?scr=9" onclick="checkSubmitBlock('btnsubmit');">
                                        <p>Consulta de TarjetaHabiente/Usuario</p>
                                    </a>
                                </li>
                            <?php } // Ver Reportes?>
                        </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a><b><?php echo utf8_encode($_SESSION['NCOMPANY']); ?></b></a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="change_password">Actualizar Contraseña</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="logout">
