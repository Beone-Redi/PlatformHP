                ...
                <div class="row">
                    ...
                    <?php if ( strlen( $msg ) == 6 ) { ?> 
                        <div class="alert alert-success">
                            ...
                            <span><b> Exitoso - </b> <?php echo substr( $Respuesta , 2 );?>.</span>
                        </div>
                            ...
                            <div class="content">
                                <form action="create_company?scr=2" method="POST" enctype="multipart/form-data" onsubmit="return checkSubmitBlock('crear_company');">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="inputCards">Tarjetas a usar</label>
                                    ...
                                    <input type="submit" id="crear_company" value="Guardar" class="btn btn-info btn-fill pull-right"/>
